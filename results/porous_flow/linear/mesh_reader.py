...
elif nx/len(NODES_INDEX_SUP) == VOL_ELEM_RATIO and nx/len(NODES_INDEX_INF) == VOL_ELEM_RATIO:
    print('Proporção de volumes para elementos na fronteira respeita a razão estabelecida')
