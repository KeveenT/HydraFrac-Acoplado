...
plt.grid()
plt.savefig('/home/keveent/PyEFVLib/Hydraulic_Fracture/Resultados/iterations.pdf', dpi=1200)
plt.figure()
...
plt.grid()
plt.savefig('/home/keveent/PyEFVLib/Hydraulic_Fracture/Resultados/p.pdf', dpi=1200)
plt.figure()
...
plt.grid()
plt.savefig('/home/keveent/PyEFVLib/Hydraulic_Fracture/Resultados/re.pdf', dpi=1200)
plt.figure()
...
plt.grid()
plt.savefig('/home/keveent/PyEFVLib/Hydraulic_Fracture/Resultados/v.pdf', dpi=1200)
plt.figure()
...
plt.grid()
plt.legend()
plt.savefig('/home/keveent/PyEFVLib/Hydraulic_Fracture/Resultados/leakoff.pdf', dpi=1200)
plt.figure()
...
plt.grid()
plt.savefig('/home/keveent/PyEFVLib/Hydraulic_Fracture/Resultados/conservação.pdf', dpi=1200)
plt.figure()
